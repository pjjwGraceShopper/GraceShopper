    ...
    <div className='sidebar-container'>
      ...
      <div className='app-container'>
        <Routes>
          ...
          <Route path='/login' element={ <Login setMe={setMe} me={me} loginStatus={loginStatus}  setLoginStatus={setLoginStatus}  /> } />
          <Route path='/sign-up' element={ <SignUp setMe={setMe} loginStatus={loginStatus} setLoginStatus={setLoginStatus} />} />
